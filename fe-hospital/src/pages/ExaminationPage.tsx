      ...
      <div className="bg-white rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden">
        ...
        <div className="flex border-b border-gray-100 p-2 bg-gray-50/50">
          ...
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-3 py-4 rounded-2xl font-bold transition-all relative ${
              ...
              {!isReadOnly && (
                <div className="flex justify-end gap-3 pt-4 border-t border-gray-50">
                  <button 
                    ...
                    disabled={submitting}
                    className="flex items-center gap-2 px-8 py-3 border-2 border-primary text-primary hover:bg-primary/5 rounded-2xl font-bold transition-all disabled:opacity-50"
                  >
                    {submitting ? <Loader2 className="w-5 h-5 animate-spin" /> : <Save className="w-5 h-5" />}
                    Lưu đơn thuốc
                  </button>
